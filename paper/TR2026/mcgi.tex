...
\begin{itemize}
    ...
    \item We conduct comprehensive empirical evaluations against three industry-standard baselines across five datasets ranging from million to billion scales. Results demonstrate that MCGI achieves $5.8\times$ higher throughput on high-dimensional vectors (e.g., GIST1M) and reduces query latency by $3\times$ on the billion-scale SIFT1B compared to DiskANN, confirming its robustness in mitigating both I/O and computational bottlenecks across diverse production environments.
\end{itemize}
