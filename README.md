...
Here's what I suggest for running the billion-scale experiments on SIFT1B dataset: 80+ CPU cores, 256 GB+ memory (in which 150 GB is budgeted in the parameters; details see below), and 1 TB NVMe SSD. Then you'll be able to have a full run of index building finished within ~10 hours if your system is relatively new. Detailed usage are as follows: 
...
## Technical Reports
* [HPDIC-AdaDisk-TR2026](arXiv:2606.TBA)
* [HPDIC-AdaDisk-TR2025](paper/icml26/main.pdf)
