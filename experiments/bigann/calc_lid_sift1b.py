...
# 配置路径
DATA_DIR = os.path.expanduser("~/hpdic/sift1b_data")
RAW_FILE = os.path.join(DATA_DIR, "sift1b_base.bin")
LID_FILE = os.path.join(DATA_DIR, "sift1b_lid.bin")

# 算法参数
K_NEIGHBORS = 10  # 计算 LID 通常取 k=10~30 之间
