...
void add_new_file_to_single_index(const std::string &index_file, const std::string &new_file)
{
...
int build_merged_vamana_index(const std::string &base_file, diskann::Metric compareMetric, uint32_t L, uint32_t R,
                              double sampling_rate, double ram_budget, const std::string &mem_index_path,
                              const std::string &medoids_file, const std::string &centroids_file, size_t build_pq_bytes, bool use_opq,
...
template <typename T, typename LabelT>
uint32_t optimize_beamwidth(diskann::PQFlashIndex<T, LabelT> *pFlashIndex, const T *tuning_sample,
...
// This code should only be available in the "build" DLL.
    ...
    timer.reset();
    diskann::build_merged_vamana_index<T, LabelT>(data_file_to_use, diskann::Metric::L2, L, R, p_val,
                     ...
                     const std::string &lid_file_path, float alpha_min, float alpha_max)
{
    ...
    // 3. 构建 IndexWriteParameters (分步构建避免拷贝错误)
...
template DISKANN_DLLEXPORT uint32_t optimize_beamwidth<int8_t, uint32_t>(
    diskann::PQFlashIndex<int8_t, uint32_t> *index_ptr, const int8_t *tuning_sample,
...
template DISKANN_DLLEXPORT uint32_t optimize_beamwidth<uint8_t, uint32_t>(
    diskann::PQFlashIndex<uint8_t, uint32_t> *index_ptr, const uint8_t *tuning_sample,
    uint64_t tuning_sample_num, uint64_t tuning_sample_aligned_dim, uint32_t L, uint32_t nthreads, uint32_t start_bw);
template DISKANN_DLLEXPORT uint32_t optimize_beamwidth<float, uint32_t>(
    diskann::PQFlashIndex<float, uint32_t> *index_ptr, const float *tuning_sample,
    uint64_t tuning_sample_num, uint64_t tuning_sample_aligned_dim, uint32_t L, uint32_t nthreads, uint32_t start_bw);

template DISKANN_DLLEXPORT uint32_t optimize_beamwidth<int8_t, uint16_t>(
    diskann::PQFlashIndex<int8_t, uint16_t> *index_ptr, const int8_t *tuning_sample,
    uint64_t tuning_sample_num, uint64_t tuning_sample_aligned_dim, uint32_t L, uint32_t nthreads, uint32_t start_bw);
template DISKANN_DLLEXPORT uint32_t optimize_beamwidth<uint8_t, uint16_t>(
    diskann::PQFlashIndex<uint8_t, uint16_t> *index_ptr, const uint8_t *tuning_sample,
    uint64_t tuning_sample_num, uint64_t tuning_sample_aligned_dim, uint32_t L, uint32_t nthreads, uint32_t start_bw);
template DISKANN_DLLEXPORT uint32_t optimize_beamwidth<float, uint16_t>(
    diskann::PQFlashIndex<float, uint16_t> *index_ptr, const float *tuning_sample,
    uint64_t tuning_sample_num, uint64_t tuning_sample_aligned_dim, uint32_t L, uint32_t nthreads, uint32_t start_bw);
...
template DISKANN_DLLEXPORT int build_merged_vamana_index<int8_t, uint32_t>(
    const std::string &base_file, diskann::Metric compareMetric, uint32_t L, uint32_t R, double sampling_rate,
    double ram_budget, const std::string &mem_index_path, const std::string &medoids_path, const std::string &centroids_file,
